    ...
    return (
      <Card className="max-w-2xl mx-auto bg-black/20 backdrop-blur-sm border-white/20">
        ...
        <CardContent className="text-center">
          ...
          <p className="text-gray-400 mb-4">Vá para a aba "Criar Monstro" e dê vida ao seu primeiro guerreiro!</p>
        </CardContent>
      </Card>
    )
  }
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {monsters.map((monster) => (
          <MonsterCard key={monster.id} monster={monster} showActions />
        ))}
      </div>
    </div>
  )
